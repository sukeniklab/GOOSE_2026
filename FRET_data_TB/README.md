...
* ```controls.csv``` - aggregated data from control wells of all experimental plates (7) used for this. Contains MTQ and MNG uncoupled fluorophores, and is used to produce Figsi_ArtifactCorrections.ipynb
